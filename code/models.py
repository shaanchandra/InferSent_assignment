...
#The main LSTM Class for all LSTM-type networks. Includes instance of LSTM/biLSTM/biLSTM(with pool) based on option and Classifier      
class LSTM_main(nn.Module):
    ...
    def forward(self, tuples):
        ...
        #s1_tuple = (s1_batch, s1_lens), s2_tuple = (s2_batch, s2_lens)
